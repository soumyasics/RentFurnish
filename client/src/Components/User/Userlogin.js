      ...
      <div className='container'>
        <div className='row'>
          ...
          <div className='col-sm-12 col-md-4 col-lg-4 userlogin-main-two'>
            ...
            <div className='col-6 pb-3'>
             <Link to="/userforgetpswd" style={{textDecoration:"none", color:"black"}}><p>Recover Password ?</p></Link>
            </div>
            <div className='col-6 pb-3"'>
            ...
            <div className='col-6 pb-3"'>
              ...
              <Link to="/usersignin" style={{textDecoration:"none", color:"black"}}><h6 className='idd2' >Create One ?</h6></Link>
            </div>
