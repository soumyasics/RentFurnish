...
function Shopforgetpswd() {
  ...
  const handlesubmit = (e) => {
    ...
    if (!passwordError && !confirmPasswordError) {
      ...
      axiosInstance.post(`/forgetpswdshop`, password)
        .then((result) => {
          console.log(result);
  ...
  return (
    ...
    <Link to="/shoplogin"><img src={img2} alt="right" width="30px" height="30px"/></Link>
